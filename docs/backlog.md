...
| 52 | #153 | Tidy after #146: repeated check sequence, unused `load_settings`, a test that patches a private name | S | none | Do it with the next change to `cli.py`. | no |
